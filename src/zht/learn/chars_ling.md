...
在靈明輸入法中，無論一個字能拆成幾個字根，我們只關心其中的**四個根**，分別是：
...
我們首先介紹一個簡單的填格子方法來理解單字編碼的組成，它可以適用於所有情況。
...
- 爲了規避重碼，靈明輸入法設置了一些**避重簡碼字**，它们的編碼不以`aoeiu`結尾，這時候需要按空格鍵（或數字1）上屏首選。
