...
- 有些是基於形狀的，凡是長大於高的都爲「曰」，凡是長短於高的都爲「日」。但這個方法會跟隨着字體的不同而不同，有時候不合字源，也不統一。例如：「<!--
  verbatim -->書<!-- verbatim -->」字源於「聿者」，「曹」古字爲「<!-- verbatim
  -->東東<!-- verbatim -->口」。
...
為防止拆分不直觀，此規定也適用於另外幾個包含「口」或者封閉空間的字根：「<!--
verbatim -->口古合户戶戸目皿罒自見早<!-- verbatim -->」等等。
...
「合」下的「口」中如果包含完整的筆畫，應該拆如「人一囗」。例如：「<!-- verbatim
-->會<!-- verbatim -->」中間的「口」中有「小」，故而應該拆成「人一日」。
...
這部分字根比較少，主要是一些出現散件的字根。這同「散件不分割」禁手類似。包括：
<!-- verbatim -->

- 貝
- 頁。如「夔」拆「䒑自止㔾夂」不拆「丷頁止㔾夂」。
- 見
- 贝
- 页
- 见
...
「夔」字中的「一自八」不作「<!-- verbatim -->頁<!-- verbatim
-->」字根拆，因爲它被「止㔾」穿插。
