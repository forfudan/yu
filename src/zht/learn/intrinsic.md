...
- 有些是基於形狀的，凡是長大於高的都爲「曰」，凡是長短於高的都爲「日」。但這個方法會跟隨着字體的不同而不同，有時候不合字源，也不統一。例如：「<!-- verbatim -->書<!-- verbatim -->」字源於「聿者」，「曹」古字爲「<!-- verbatim -->東東<!-- verbatim -->口」。
...
## <ruby>口<rt>kǒu</rt></ruby><ruby>囗<rt>wéi</rt></ruby>之辨

「<ruby>口<rt>kǒu</rt></ruby>」和「<ruby>囗<rt>wéi</rt></ruby>」。這兩個根如何區分？

答案是，如果方框裡有**完整**的筆畫，用「<ruby>囗<rt>wéi</rt></ruby>」。否則一律用「<ruby>口<rt>kǒu</rt></ruby>」。

::: tip 例

「国」字的方框中，有完整的筆畫，故而必須用「<ruby>囗<rt>wéi</rt></ruby>」。

「中」字的方框中，雖然「⼁」穿方框而過，但並未被完全包含在方框中。由於方框中沒有完整的筆畫，故而用「<ruby>口<rt>kǒu</rt></ruby>」。

:::

為防止拆分不直觀，此規定也適用於另外幾個包含「口」或者封閉空間的字根：「<!-- verbatim -->口古合户戶戸目皿罒自見早<!-- verbatim -->」等等。
...
「合」下的「口」中如果包含完整的筆畫，應該拆如「人一囗」。例如：「<!-- verbatim -->會<!-- verbatim -->」中間的「口」中有「小」，故而應該拆成「人一日」。
...
部分字根，不能分成兩次書寫，必須一體寫就，稱爲**一體寫就字根**。這些字根的特點是存在離散的部件。如果被其他字根穿插，會導致極難辯認。

這部分字根比較少，主要是一些出現散件的字根。這同「散件不分割」禁手類似。包括「<!-- verbatim -->貝頁見贝页见<!-- verbatim -->」等。

::: tip 例

「夔」字中的「一自八」不作「<!-- verbatim -->頁<!-- verbatim -->」字根拆，因爲它被「止㔾」穿插。
