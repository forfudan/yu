...
本方案基於宇浩拆分，爲 25.5 鍵、編碼自分割、五碼、三編、音托、全字集、繁簡通打輸入方案。本方案開創性極强，同傳統定長方案輸入體驗有所不同，請務必充分瞭解、分析、平衡其風險和收益後再決定是否學習使用。
...
本方案具有編碼自分割屬性，因此簡碼效率顯著高於一般的四碼定長方案，簡碼設置的**邊際效率**相對更高。綜上所述，在記憶500個簡碼的情況下，單字平均碼長約爲3。
