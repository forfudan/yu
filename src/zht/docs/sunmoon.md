...
│ dama ┆ root                                                                                                                          │
╞══════╪═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════╡
│ b    ┆ 亦i 虎hu 卜bu 爪sa 瓜ga 示ki 灬bi 魚e 馬ma                                                                                    │
│ c    ┆ 氵ko 女ne 來le 世ki 飛fo 乙i 又u 生ke 禾he                                                                                    │
│ d    ┆ 长re 宀ma 口ke 己ji 已i 未o 末mo 母me 电da 甲ja 言a 金jo                                                                      │
│ f    ┆ 乃ne 水ko 丿pe 廴o 鱼e 一i 匚fe 牙a 手ke 面ma 而o 食ki                                                                        │
│ g    ┆ 扌ke 革ge 夭i 九ju 儿o 广go 疒bi 鹿lu 麻ma 牛nu 頁e 皿mo 目me 貝bo 豕ki                                                       │
│ h    ┆ 亥he 舟se 自zi 忄xo 辰re 其qi 下xa 丁di 鸟ni 乌u 习xi 冊ce 冂ji 勹bi 齒ri 止si 走ze 田ta 页e 贝bo                             │
│ j    ┆ 心xo 门me 見ja 矢ki 夕xi 丰fe 刀di 上ke 寸ci 巴ba 巳si 日i 曰e 早zi 片pa 爿pa 鬼go                                            │
│ k    ┆ 马ma 之si 丬qo 古gu 弓gi 甫fu 辛xo 囗o 里li 千qa 饣ki 三sa 且qe 八ba 入e 凵ka 屮ci 戊u 戈ge 弋i 彳ri 彡ka 白be 臼ju 纟si 臣re │
│ l    ┆ 曲qe 穴xe 欠qa 匕bi 正se 干ga 兀u 丨gi 非fo 予e 了le 子zi 高gi 方fe 亡o 亠te 向xo 小xi 幺i 糸si 辶ro 髟bi 長re                │
│ m    ┆ 耳o 不bu 艮ge 丑re 乜me 也e 七qi 瓦a 工gi 卅sa 艹ci 虫ri 風fe                                                                 │
│ n    ┆ 足zu 厶si 亍ru 壬o 缶fe 丶da 冖mi 厂re 巛ri 川ri 月e                                                                          │
│ p    ┆ 雨e 大da 夫fu 犬qi 犭qi 豸si                                                                                                  │
│ q    ┆ 几ji 殳ku 卯mi                                                                                                                │
│ r    ┆ 毛mi 丌ji 王o 文i 黑ho 立li 石ki 身ke 烏u 鳥ni 車re 門me 鬥de                                                                 │
│ s    ┆ 至si 用i 舌ke 二o 冫o 尤u 尢o 户hu 尸ki 彐ji 肀e 隶li 木me                                                                    │
│ t    ┆ 巾jo 由u 火ho 皮pi 十ki 攵pu 夂pu 尚ke 衤i                                                                                    │
│ v    ┆ 山ka 见ja 讠a 米mi 业e 车re 乂i 士ki 土du 斤jo 戶hu                                                                           │
│ w    ┆ 力li 人o 合he 隹co 亻o 骨gu 禺e 申ke                                                                                          │
│ x    ┆ 丷ba 䒑ci 羊o 钅jo                                                                                                            │
│ y    ┆ 阝fu 刂di 竹su 气qi 酉u 西xi                                                                                                  │
└──────┴───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────┘
```
...
1. 用**漢字結構**和**末筆信息**作爲補充編碼。主要解决同拆異形（如「束杏」）、提高末根離散。最早可追溯到**五筆**。它的缺點是不僅需要知道結構和末筆，還需要進行一次交叉映射，使用时難以形成肌肉記憶。
...
- **卿雲**：字根雙編碼、小碼取聲、首根小碼不取、不分主副根、首根分區。兩根字編碼：`AZza`
...
减少空格鍵使用，一個是使用連續輸入，比如全碼連打。但字和字之間的分隔是模糊的，需要用詞庫來進行預測。一般情況比較準確，但有時也會出現分隔錯誤，比如「不二」和「些」在卿雲中都是`NBAE`，「説一不二」常常被預測為「説一些」。
...
1. 第一步，將末尾空格鍵替換為若干B區按鍵的集合 `AaZzƒ`，其中 `ƒ` 代表B區按鍵。
1. 第二步，讓B區按鍵`ƒ`和末根`Z`有某種內在的聯繫。問題是，如何讓一個字根的小碼能分成兩部分呢？一個自然的思路就是**聲母**和**韻母**。因為在漢語拼音中，聲母所在的按鍵，和元音所在的按鍵是隔離的。我們只要定義A區的按鍵為`BCDFGHJKLNMPQRSTVWXYZ`，B區的按鍵為`AEIOU`，便能自然形成隔離。比如「千」的第一小碼取聲母`Q`，第二小碼將韻母`IAN`映射到B區按鍵中的某個按鍵即可。
...
如何解決這個問題？我從卿雲的小碼設計中找到了答案，並且同時解決了以上三個問題。卿雲中，零聲母的`yi`韻，直接取了小碼`I`，而不是`Y`。這個方法可以適用到新方案中。對於部分零聲母的字根，我們可以無視它的聲碼，直接取韻碼。也就是説，這些字根字全碼只有兩碼：`Zⓩ`。那麼，單字的編碼可行組合明顯增加：
...
這個方案，雖然在按鍵區分了A區和B區，但它不同於**頂功**方案。頂功方案中，只有輸入了下一個字的A區鍵，纔意味著上一個字輸入完畢，可以上屏。而本方案中，只要出現B區按鍵（韻碼），便意味着這個字已經輸入完畢，可以上屏了。而A區按鍵，如同前綴一樣附著在最後的B區按鍵上。嚴格地說，它應該叫**前綴碼**方案。
