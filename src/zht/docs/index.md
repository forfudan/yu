...
因爲編碼資源的有限性，每個輸入法都有自己的設計目標和取捨。有優點的同時也會有缺點。大家需要根據自己的需求和偏好，選擇其中最適合自己的那個輸入方案。當然，作者在此有以下推薦：
