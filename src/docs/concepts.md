...
`見到一個人`这五个字，狭义上，我们认为「见」「个」是繁体字；广义上，我们可以说这五个字都是繁体字（繁体中文）。
...
- 宇浩日月方案：末码必须以`aeiou`等元音字母结尾或者达到最大码长5，韵码前可以有若干辅音字母，首码不得为`z`
- 故而编码空间大小为 $5 + 20 \times 5 + 20 \times 21 \times 5 + 20 \times 21^2 \times 5 + 20 \times 21^3 \times 5 + 20 \times 21^4 = 4862025$。
...
郑码输入法：「见见」二字字形不同，但音义相同，后者为前者的简化。因此它们被归并到「见」字根上，赋予相同的编码`Lr`。
...
字根音联，是指在输入法中，部分字根通过其**读音**来联系起来，并赋予它们相同的大码。
...
字根义联，是指在输入法中，部分字根通过其**形态**来联系起来，并赋予它们相同的大码。
