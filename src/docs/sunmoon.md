...
如果一个字根无音、或为生僻字、或读音繁杂，则声码为空，韵码取`O`。
...
| ～ü yu                                | ～ㄩ                                                    | V    | 鱼 Be  |                    |
| shi                                   | ㄕ                                                      | A    | 十 TKa | shi时              |
| zhi chi zi ci si                      | ㄓ ㄔ ㄗ ㄘ ㄙ                                          | I    | 子 Lzi | 非shi时            |
| ri                                    | ㄖ                                                      | I    | 日 Ji  |                    |
| ru                                    | ㄖㄨ                                                    | E    | 入 Ke  |                    |
| ren                                   | ㄖㄣ                                                    | O    | 人 Wo  |                    |
