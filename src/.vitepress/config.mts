    ...
    socialLinks: [
      {
        ...
        <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" stroke-width="0" xmlns="http://www.w3.org/2000/svg">
      ...
      {
        icon: {
          svg: `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" stroke-width="0" class="bi bi-tencent-qq" viewBox="0 0 16 16">
